...
import { ArrowRight, AlertCircle, CheckCircle, Lightbulb, Search, Zap } from 'lucide-react';
import { metrics, painPoints, trendingInsights, recommendations, themes } from '@/lib/mock-data';
  ...
  return (
    <div className="p-8 space-y-8 bg-gradient-to-br from-slate-950 via-purple-950/20 to-slate-900 min-h-full">
      ...
      <Link 
        ...
        className="block glass-card rounded-2xl overflow-hidden cursor-pointer hover:scale-[1.01] transition-all duration-300 border border-blue-500/20 glow-blue"
      >
